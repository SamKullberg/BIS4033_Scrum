...
<div class="content delete">
    ...
    <div class="yesno">
        <a href="prescriptions_delete.php?id=<?=$prescription['prescription_id']?>&confirm=yes">Yes</a>
        <a href="prescriptions_delete.php?id=<?=$prescription['prescription_id']?>&confirm=no">No</a>
    </div>
    <?php endif; ?>
</div>
