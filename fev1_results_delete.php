...
<div class="content delete">
    ...
    <div class="yesno">
        <a href="conversations_delete.php?fev1_id=<?=$fev1_results['fev1_id']?>&confirm=yes">Yes</a>
        <a href="conversations_delete.php?fev1_id=<?=$fev1_results['fev1_id']?>&confirm=no">No</a>
    </div>
    <?php endif; ?>
</div>
